...
`/media` without a delete action, and unused cover deletion from `/media`.
...
- Admin E2E: runs the Playwright admin test suite with the backend available in CI, including post CRUD, preview from the posts list and edit form, SEO status/filtering/search, cover upload, used media protection, and unused media deletion.
